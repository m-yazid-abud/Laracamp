@extends('layouts.front', ['title' => 'Laracamp Landing Page'])

@section('title', 'Laracamp Landing Page')
...
@section('content')
        ...
        <div class="container">
                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 text-center">
                            <a href="#">
                                <img src="{{ Vite::asset('resources/images/banner.png') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="row brands">
                <div class="col-lg-12 col-12 text-center">
                    <img src="{{ Vite::asset('resources/images/brands.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="{{ Vite::asset('resources/images/ic_globe.png') }}" class="icon" alt="">
                        <h3 class="title">
                            Diversity
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="{{ Vite::asset('resources/images/ic_globe-1.png') }}" class="icon" alt="">
                        <h3 class="title">
                            A.I Guideline
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="{{ Vite::asset('resources/images/ic_globe-2.png') }}" class="icon" alt="">
                        <h3 class="title">
                            1-1 Mentoring
                        </h3>
                        <p class="support">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        <img src="{{ Vite::asset('resources/images/ic_globe-3.png') }}" class="icon" alt="">
                        <h3 class="title">
                            Future Job
                        </h3>
                        <p class="support">
    ...
    <section class="steps">
        <div class="container">
            <div class="row item-step pb-70">
                <div class="col-lg-6 col-12 text-center">
                    <img src="{{ Vite::asset('resources/images/step1.png') }}" class="cover" alt="">
                </div>
            ...
            <div class="row item-step pb-70">
                ...
                <div class="col-lg-6 col-12 text-center">
                    <img src="{{ Vite::asset('resources/images/step2.png') }}" class="cover" alt="">
                </div>

            </div>
            <div class="row item-step">
                <div class="col-lg-6 col-12 text-center">
                    <img src="{{ Vite::asset('resources/images/step3.png') }}" class="cover" alt="">
                </div>
                <div class="col-lg-6 col-12 text-left copywriting">
                    <p class="story">
                        END GAME
    ...
    <section class="pricing" id="pricing">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <p>
                                    <a href="{{ route('order.create', 'gila-belajar') }}"
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{ route('order.create', 'baru-mulai') }}"
            ...
            <div class="row pb-70">
                <div class="col-lg-12 col-12 text-center">
                    <img src="{{ Vite::asset('resources/images/brands.png') }}" height="30" alt="">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                <img src="{{ Vite::asset('resources/images/stars.svg') }}" alt="">
                                <p class="message">
                                    I was not really into code but after they teach me how to train my logic then I was
                                    really fall in love with code
                                </p>
                                <div class="user">
                                    <img src="{{ Vite::asset('resources/images/fanny_photo.png') }}" class="photo"
                                        alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Fanny
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{ Vite::asset('resources/images/angga.png') }}" class="photo"
                                        alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Angga
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{ Vite::asset('resources/images/beatrice.png') }}" class="photo"
                                        alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Beatrice
